...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.movieVH>  {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavouriteAdapter.movieVH movieVH, int position) {
